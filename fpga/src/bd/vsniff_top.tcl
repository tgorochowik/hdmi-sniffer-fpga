...
################################################################
# This is a generated script based on design: vsniff_top
#
...
proc create_root_design { parentCell } {
  ...
  set ext_rst [ create_bd_port -dir I ext_rst ]
  set mode_err [ create_bd_port -dir O mode_err ]
  set mode_rgb [ create_bd_port -dir O mode_rgb ]
  set mode_tmds [ create_bd_port -dir O mode_tmds ]
  set tmds_clk [ create_bd_port -dir O tmds_clk ]
  set tmds_in_clk_n [ create_bd_port -dir I tmds_in_clk_n ]
  set tmds_in_clk_p [ create_bd_port -dir I tmds_in_clk_p ]
  set tmds_in_d0_n [ create_bd_port -dir I tmds_in_d0_n ]
  set tmds_in_d0_p [ create_bd_port -dir I tmds_in_d0_p ]
  set tmds_in_d1_n [ create_bd_port -dir I tmds_in_d1_n ]
  set tmds_in_d1_p [ create_bd_port -dir I tmds_in_d1_p ]
  set tmds_in_d2_n [ create_bd_port -dir I tmds_in_d2_n ]
  set tmds_in_d2_p [ create_bd_port -dir I tmds_in_d2_p ]
...
CONFIG.PCW_S_AXI_HP1_FREQMHZ {40} \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: rst_processing_system7_1_142M, and set properties
  set rst_processing_system7_1_142M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_processing_system7_1_142M ]

  # Create instance: sniffer_0, and set properties
  set sniffer_0 [ create_bd_cell -type ip -vlnv tkgk:tkgk:sniffer:1.0 sniffer_0 ]

  # Create instance: tmds_deserializer_0, and set properties
  set tmds_deserializer_0 [ create_bd_cell -type ip -vlnv tkgk:tkgk:tmds_deserializer:1.0 tmds_deserializer_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins sniffer_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net sniffer_0_M00_AXIS [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins sniffer_0/M00_AXIS]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins rst_processing_system7_1_142M/interconnect_aresetn]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins rst_processing_system7_1_142M/peripheral_aresetn]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins processing_system7_1/IRQ_F2P]
  connect_bd_net -net ext_rst_1 [get_bd_ports ext_rst] [get_bd_pins tmds_deserializer_0/ext_rst]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sniffer_0/m00_axis_aresetn]
  connect_bd_net -net proc_sys_reset_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins sniffer_0/s00_axi_aresetn]
  connect_bd_net -net processing_system7_1_FCLK_CLK4 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins processing_system7_1/FCLK_CLK2] [get_bd_pins processing_system7_1/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_1_142M/slowest_sync_clk] [get_bd_pins sniffer_0/sysclk]
  connect_bd_net -net processing_system7_1_fclk_clk0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins sniffer_0/s00_axi_aclk] [get_bd_pins tmds_deserializer_0/sysclk]
  connect_bd_net -net processing_system7_1_fclk_reset0_n [get_bd_ports RESET_N] [get_bd_pins proc_sys_reset/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins processing_system7_1/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_1_142M/ext_reset_in]
  connect_bd_net -net sniffer_0_m00_axis_fsync [get_bd_pins axi_vdma_0/s2mm_fsync] [get_bd_pins sniffer_0/m00_axis_fsync]
  connect_bd_net -net sniffer_0_mode_err [get_bd_ports mode_err] [get_bd_pins sniffer_0/mode_err]
  connect_bd_net -net sniffer_0_mode_rgb [get_bd_ports mode_rgb] [get_bd_pins sniffer_0/mode_rgb]
  connect_bd_net -net sniffer_0_mode_tmds [get_bd_ports mode_tmds] [get_bd_pins sniffer_0/mode_tmds]
  connect_bd_net -net sniffer_0_pixel_clk [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins sniffer_0/m00_axis_aclk] [get_bd_pins sniffer_0/pixel_clk]
  connect_bd_net -net tmds_deserializer_0_data_ready [get_bd_pins sniffer_0/data_ready] [get_bd_pins tmds_deserializer_0/data_ready]
  connect_bd_net -net tmds_deserializer_0_data_valid [get_bd_ports data_valid] [get_bd_pins tmds_deserializer_0/data_valid]
  connect_bd_net -net tmds_deserializer_0_tmds_clk [get_bd_ports tmds_clk] [get_bd_pins sniffer_0/tmds_clk] [get_bd_pins tmds_deserializer_0/tmds_clk]
  connect_bd_net -net tmds_deserializer_0_tmds_d0 [get_bd_pins sniffer_0/tmds_blue] [get_bd_pins tmds_deserializer_0/tmds_d0]
  connect_bd_net -net tmds_deserializer_0_tmds_d1 [get_bd_pins sniffer_0/tmds_green] [get_bd_pins tmds_deserializer_0/tmds_d1]
  connect_bd_net -net tmds_deserializer_0_tmds_d2 [get_bd_pins sniffer_0/tmds_red] [get_bd_pins tmds_deserializer_0/tmds_d2]
  connect_bd_net -net tmds_in_clk_n_1 [get_bd_ports tmds_in_clk_n] [get_bd_pins tmds_deserializer_0/tmds_in_clk_n]
  connect_bd_net -net tmds_in_clk_p_1 [get_bd_ports tmds_in_clk_p] [get_bd_pins tmds_deserializer_0/tmds_in_clk_p]
  connect_bd_net -net tmds_in_d0_n_1 [get_bd_ports tmds_in_d0_n] [get_bd_pins tmds_deserializer_0/tmds_in_d0_n]
  connect_bd_net -net tmds_in_d0_p_1 [get_bd_ports tmds_in_d0_p] [get_bd_pins tmds_deserializer_0/tmds_in_d0_p]
  connect_bd_net -net tmds_in_d1_n_1 [get_bd_ports tmds_in_d1_n] [get_bd_pins tmds_deserializer_0/tmds_in_d1_n]
  connect_bd_net -net tmds_in_d1_p_1 [get_bd_ports tmds_in_d1_p] [get_bd_pins tmds_deserializer_0/tmds_in_d1_p]
  connect_bd_net -net tmds_in_d2_n_1 [get_bd_ports tmds_in_d2_n] [get_bd_pins tmds_deserializer_0/tmds_in_d2_n]
  connect_bd_net -net tmds_in_d2_p_1 [get_bd_ports tmds_in_d2_p] [get_bd_pins tmds_deserializer_0/tmds_in_d2_p]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_vdma_0/Data_S2MM] [get_bd_addr_segs processing_system7_1/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_1_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs sniffer_0/S00_AXI/S00_AXI_reg] SEG_sniffer_0_S00_AXI_reg
...
preplace port mode_rgb -pg 1 -y 700 -defaultsOSRD
preplace port tmds_in_d0_n -pg 1 -y 710 -defaultsOSRD
preplace port tmds_in_clk_n -pg 1 -y 670 -defaultsOSRD
preplace port mode_tmds -pg 1 -y 720 -defaultsOSRD
preplace port tmds_in_d2_n -pg 1 -y 790 -defaultsOSRD
preplace port ext_rst -pg 1 -y 610 -defaultsOSRD
preplace port tmds_in_d1_n -pg 1 -y 750 -defaultsOSRD
preplace port tmds_in_d0_p -pg 1 -y 690 -defaultsOSRD
preplace port tmds_in_clk_p -pg 1 -y 650 -defaultsOSRD
preplace port data_valid -pg 1 -y 860 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 150 -defaultsOSRD
preplace port tmds_in_d2_p -pg 1 -y 770 -defaultsOSRD
preplace port tmds_in_d1_p -pg 1 -y 730 -defaultsOSRD
preplace port mode_err -pg 1 -y 740 -defaultsOSRD
preplace port FCLK_CLK0 -pg 1 -y 210 -defaultsOSRD
preplace port tmds_clk -pg 1 -y 550 -defaultsOSRD
preplace port RESET_N -pg 1 -y 250 -defaultsOSRD
preplace inst processing_system7_1 -pg 1 -lvl 5 -y 180 -defaultsOSRD
preplace inst axi_vdma_0 -pg 1 -lvl 3 -y 370 -defaultsOSRD
preplace inst rst_processing_system7_1_142M -pg 1 -lvl 3 -y 170 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 4 -y 440 -defaultsOSRD
preplace inst tmds_deserializer_0 -pg 1 -lvl 4 -y 700 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -y 220 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 4 -y 160 -defaultsOSRD
preplace inst sniffer_0 -pg 1 -lvl 5 -y 710 -defaultsOSRD
preplace inst proc_sys_reset -pg 1 -lvl 1 -y 520 -defaultsOSRD
preplace netloc processing_system7_1_ddr 1 5 1 NJ
preplace netloc tmds_deserializer_0_tmds_d0 1 4 1 1480
preplace netloc tmds_deserializer_0_data_valid 1 4 2 NJ 870 NJ
preplace netloc proc_sys_reset_interconnect_aresetn 1 1 1 350
preplace netloc processing_system7_1_M_AXI_GP0 1 1 5 360 10 NJ 10 NJ 10 NJ 10 2000
preplace netloc tmds_deserializer_0_tmds_d1 1 4 1 1500
preplace netloc processing_system7_1_fclk_clk0 1 0 6 30 420 360 420 680 40 1090 340 1530 60 2010
preplace netloc proc_sys_reset_peripheral_aresetn 1 1 4 350 550 700 550 NJ 550 1460
preplace netloc axi_vdma_0_s2mm_introut 1 3 2 NJ 350 1460
preplace netloc tmds_deserializer_0_tmds_d2 1 4 1 1510
preplace netloc sniffer_0_mode_rgb 1 5 1 NJ
preplace netloc sniffer_0_m00_axis_fsync 1 2 4 720 530 NJ 530 NJ 530 1990
preplace netloc tmds_deserializer_0_data_ready 1 4 1 1520
preplace netloc sniffer_0_mode_err 1 5 1 NJ
preplace netloc proc_sys_reset_1_peripheral_aresetn 1 4 1 1490
preplace netloc ARESETN_1 1 3 1 1080
preplace netloc sniffer_0_pixel_clk 1 2 4 710 70 1060 840 1530 860 1980
preplace netloc processing_system7_1_fixed_io 1 5 1 NJ
preplace netloc sniffer_0_M00_AXIS 1 2 4 720 80 NJ 310 NJ 310 2000
preplace netloc tmds_in_d2_n_1 1 0 4 NJ 790 NJ 790 NJ 790 NJ
preplace netloc tmds_in_d0_n_1 1 0 4 NJ 710 NJ 710 NJ 710 NJ
preplace netloc processing_system7_1_fclk_reset0_n 1 0 6 20 20 NJ 20 690 30 1120 330 NJ 330 2010
preplace netloc axi_interconnect_0_M04_AXI 1 2 3 NJ 260 NJ 560 1500
preplace netloc sniffer_0_mode_tmds 1 5 1 NJ
preplace netloc processing_system7_1_FCLK_CLK4 1 2 4 700 60 1110 320 1540 300 2000
preplace netloc tmds_in_d2_p_1 1 0 4 NJ 770 NJ 770 NJ 770 NJ
preplace netloc axi_interconnect_0_M01_AXI 1 2 1 670
preplace netloc tmds_in_d0_p_1 1 0 4 NJ 690 NJ 690 NJ 690 NJ
preplace netloc tmds_in_clk_p_1 1 0 4 NJ 650 NJ 650 NJ 650 NJ
preplace netloc tmds_in_clk_n_1 1 0 4 NJ 670 NJ 670 NJ 670 NJ
preplace netloc axi_vdma_0_M_AXI_S2MM 1 3 1 1070
preplace netloc axi_interconnect_1_M00_AXI 1 4 1 N
preplace netloc tmds_in_d1_p_1 1 0 4 NJ 730 NJ 730 NJ 730 NJ
preplace netloc tmds_in_d1_n_1 1 0 4 NJ 750 NJ 750 NJ 750 NJ
preplace netloc tmds_deserializer_0_tmds_clk 1 4 2 1470 550 NJ
preplace netloc ext_rst_1 1 0 4 NJ 610 NJ 610 NJ 610 NJ
preplace netloc S00_ARESETN_1 1 3 1 1130
levelinfo -pg 1 0 190 520 890 1290 1760 2030 -top 0 -bot 880
",
}
